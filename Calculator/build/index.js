...
const myCalculator = async () => {
    ...
    let addition = operations.operator == "Addition" ? input1.number1 + input2.number2 : "";
    let subtraction = operations.operator == "Subtraction" ? input1.number1 - input2.number2 : "";
    let multiplication = operations.operator == "Multiplication"
        ? input1.number1 * input2.number2
        : "";
    let division = operations.operator == "Devision" ? input1.number1 / input2.number2 : "";
